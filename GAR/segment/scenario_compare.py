...
def scenario_compare(cond_quant_raw,cond_quant_shocked,fitparam,fitparam_shocked,horizon,fitdate):
...
#                connectionstyle="angle3,angleA=0,angleB=90"),)
        ...
        print ('cond_quant_raw',cond_quant_raw)
        print ('cond_quant_shocked',cond_quant_shocked)
        asfit_raw=asymt_fit(cond_quant_raw,fitparam)
        asfit_shocked=asymt_fit(cond_quant_shocked,fitparam_shocked)
